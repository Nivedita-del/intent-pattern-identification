...
transform_gate = Dense(units=K.int_shape(cnns)[-1], bias_initializer=gate_bias_init, activation='sigmoid')(
    hway_input)
...
cb_chkpt = ModelCheckpoint('checkpoints/_' + modelname + '{epoch:02d}-{val_loss:.2f}.h5', verbose=1,
